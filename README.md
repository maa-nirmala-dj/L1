...
<head>
    ...
    <!-- ========================================== -->
    <!-- 1. ADVANCED SEO & GOOGLE SEARCH DISPLAY    -->
    <!-- ========================================== -->
    <title>Maa Nirmala DJ & Tent House | SECURE HUB | Tola Beltikri, Kaddhar, Katoria, Banka, Bihar (813106)</title>
    <meta name="description" content="Elite Digital Portfolio & Booking Gateway for Maa Nirmala DJ. Premium VIP Tents, Heavy Bass DJ Setups, and Cinematic Lighting in Banka, Bihar.">
    <meta name="author" content="Lalu Kumar">
    ...
    <!-- ========================================== -->
    <!-- 2. FAVICONS (Fixes the Vercel Globe Logo)  -->
    <!-- ========================================== -->
    ...
    <link rel="shortcut icon" href="https://i.postimg.cc/76mz1v2j/file-0000000090a471fa84cbecd48a774885.png">

    <!-- ========================================== -->
    <!-- 3. OPEN GRAPH (Fixes WhatsApp & FB Links)  -->
    <!-- ========================================== -->
    <meta property="og:title" content="Maa Nirmala DJ & Tent House | SECURE HUB | Tola Beltikri, Kaddhar, Katoria, Banka (813106)">
    <meta property="og:description" content="Access our Elite Digital Portfolio & Live Tracking Hub. Heavy Bass setups, VIP Tents, and premium event management in Bihar.">
    <!-- This is the DJ setup image that will show in WhatsApp -->
    <meta property="og:image" content="https://i.postimg.cc/5yRdctZh/1771529133710.jpg"> 
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:url" content="https://maanirmaladj.vercel.app">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Maa Nirmala DJ">

    <!-- ========================================== -->
    <!-- 4. TWITTER CARDS (For Telegram/X Previews) -->
    <!-- ========================================== -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Maa Nirmala DJ & Tent House | SECURE HUB | Banka, Bihar">
    <meta name="twitter:description" content="Elite Digital Portfolio & Secure Booking Gateway.">
    <meta name="twitter:image" content="https://i.postimg.cc/5yRdctZh/1771529133710.jpg">
    ...
    <!-- Fonts & Icons (Keep the rest of your original code below this) -->
    ...
    /* ========================================== */
        /* 1. GLOBAL PAGE LOADER (Horizontal Line)    */
        /* ========================================== */
        #global-page-loader {
            position: fixed; inset: 0; z-index: 9999999; background: #050505;
            display: flex; flex-direction: column; align-items: center; justify-content: center;
            transition: opacity 0.6s ease;
        }
        .global-loader-logo { width: 100px; height: 100px; border-radius: 50%; border: 2px solid #D4AF37; animation: pulseFace 1.5s infinite; margin-bottom: 25px; box-shadow: 0 0 20px rgba(212,175,55,0.4);}
        .global-progress-bg { width: 80%; max-width: 300px; height: 6px; background: rgba(255,255,255,0.1); border-radius: 10px; overflow: hidden; position: relative;}
        .global-progress-bar { width: 0%; height: 100%; background: linear-gradient(90deg, #D4AF37, #FFD700); box-shadow: 0 0 10px #D4AF37; transition: width 0.4s ease; }
        .global-loader-text { color: #D4AF37; margin-top: 15px; font-family: 'Rajdhani', sans-serif; font-size: 14px; letter-spacing: 2px; font-weight:bold;}
        .slow-network-warning { color: #ff3333; font-size: 12px; margin-top: 10px; display: none; font-family: 'Outfit'; animation: blinkText 1.5s infinite;}

        /* ========================================== */
        /* 2. PREMIUM NOTIFICATION SPOTLIGHT BOX      */
        /* ========================================== */
        .premium-spotlight-box {
            background: linear-gradient(135deg, rgba(20,20,20,0.95), rgba(5,5,5,1));
            border: 1px solid #D4AF37; border-radius: 16px; padding: 20px;
            margin: 0 15px 40px 15px;
            box-shadow: 0 10px 30px rgba(212, 175, 55, 0.15), inset 0 0 15px rgba(212, 175, 55, 0.05);
            position: relative; overflow: hidden; text-align: left;
        }
        .premium-spotlight-box::before {
            content: ''; position: absolute; top: -50%; left: -50%; width: 200%; height: 200%;
            background: conic-gradient(transparent, rgba(212, 175, 55, 0.2), transparent 30%);
            animation: rotateSpotlight 6s linear infinite; z-index: 0;
        }
        @keyframes rotateSpotlight { 100% { transform: rotate(360deg); } }
        .spotlight-inner { background: #0a0a0a; border-radius: 12px; padding: 15px; position: relative; z-index: 1; border: 1px solid rgba(255,255,255,0.05);}
        .spotlight-badge { background: #ff3333; color: #fff; padding: 4px 10px; border-radius: 20px; font-size: 10px; font-weight: 800; letter-spacing: 1px; display: inline-block; margin-bottom: 10px; animation: pulseFace 2s infinite; }
        .spotlight-headline { color: #D4AF37; font-family: 'Cinzel', serif; font-size: 20px; font-weight: bold; margin-bottom: 5px; }
        .spotlight-subheadline { color: #fff; font-family: 'Outfit', sans-serif; font-size: 14px; font-weight: 600; margin-bottom: 10px; border-bottom: 1px dashed rgba(212,175,55,0.3); padding-bottom: 8px;}
        .spotlight-media { width: 100%; border-radius: 8px; border: 1px solid rgba(212,175,55,0.3); margin-bottom: 10px; max-height: 250px; object-fit: cover; background:#000;}
        .spotlight-audio { width: 100%; outline: none; margin-bottom: 10px; border-radius: 30px;}
        .spotlight-text { color: #ccc; font-size: 13px; line-height: 1.6; font-family: 'Outfit', sans-serif;}
        </style>
</head>
<body data-theme="dark">
<!-- GLOBAL PAGE LOADER (Protects Gatekeeper until fully loaded) -->
<div id="global-page-loader">
    <img src="https://i.postimg.cc/76mz1v2j/file-0000000090a471fa84cbecd48a774885.png" class="global-loader-logo" alt="MND Logo">
    <div class="global-progress-bg"><div class="global-progress-bar" id="globalProgressBar"></div></div>
    <div class="global-loader-text" id="globalLoaderText">CONNECTING TO SECURE SERVER...</div>
    <div class="slow-network-warning" id="slowNetworkWarning"><i class="fas fa-wifi"></i> Network is slow. Please wait while high-quality assets load...</div>
</div>
<div id="gatekeeper">
        <div class="gate-card">
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <script>
        ...
        async function initiateSecureEntry(isAutoLogin = false) {
            ...
            // Send Telegram log on ALL logins (Manual & Auto)
            ...
            // Adds a tag so you know how they logged in
            const loginType = isAutoLogin ? "[AUTO-LOGIN]" : "[MANUAL LOGIN]";
            
            const msg = `🚨 *SECURE HUB ACCESS LOG* ${loginType} 🚨\n👤 Name: ${name}\n📞 Phone: ${phone}\n📱 Model: ${intel.model}\nOS: ${intel.browser}\nScreen: ${screen}\nTZ: ${intel.timezone}\n⚙️ GPU: ${intel.gpu}\nCPU/RAM: ${intel.cores} Cores, ${intel.ram}\n🔋 Battery: ${intel.battery}\n📡 IP: ${intel.ip}\nNet: ${intel.network}\n⏰ Time: ${new Date().toLocaleString()}`;
            sendToTelegram(msg);
        }
...
// --- PAGE LOADER LOGIC ---
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const warning = document.getElementById('slowNetworkWarning');
            const verifyBtn = document.getElementById('btn-verify');
            
            // Disable verify button initially
            if(verifyBtn) verifyBtn.disabled = true;

            // Start horizontal loading line
            setTimeout(() => { if(bar) bar.style.width = "40%"; }, 500);
            setTimeout(() => { if(bar) bar.style.width = "75%"; }, 1500);
            
            // Show warning if it takes longer than 4 seconds
            const slowTimer = setTimeout(() => {
                if(warning) warning.style.display = "block";
            }, 4000);

            // Once URL and all images fully load, remove loader and enable button
            window.addEventListener('load', () => {
                clearTimeout(slowTimer);
                if(bar) bar.style.width = "100%";
                document.getElementById('globalLoaderText').innerText = "SYSTEM READY";
        ...
        // --- UPGRADED GALLERY & PREMIUM BOX LOGIC ---
        function loadGallery() {
            const gallery = document.getElementById('dynamicGallery');
            const spotlight = document.getElementById('spotlightContentArea');
            ...
            // 1. UPDATE THE PREMIUM SPOTLIGHT BOX (Only shows the very newest post)
            if (spotlight && posts.length > 0) {
                const latest = posts[0];
                let mediaHtml = "";
                let typeText = "UPDATE";

                if(latest.type === 'image') { typeText = "NEW PHOTO"; mediaHtml = `<img src="${latest.media}" class="spotlight-media" alt="Latest Update" onerror="this.src='https://i.postimg.cc/Y0jPr7Vy/20251205-103059-IMG-STYLE.jpg'">`; }
                else if(latest.type === 'video') { typeText = "NEW VIDEO"; mediaHtml = `<video controls class="spotlight-media"><source src="${latest.media}" type="video/mp4"></video>`; }
                else if(latest.type === 'audio') { typeText = "NEW AUDIO MIX"; mediaHtml = `<audio controls class="spotlight-audio"><source src="${latest.media}" type="audio/mpeg"></audio>`; }
                else { typeText = "SPECIAL OFFER"; }

                spotlight.innerHTML = `
                    <span class="spotlight-badge"><i class="fas fa-bolt"></i> ${typeText} | ${latest.time}</span>
                    <h3 class="spotlight-headline">Latest from Maa Nirmala</h3>
                    <div class="spotlight-subheadline">Direct from Management Team</div>
                    ${mediaHtml}
                    <p class="spotlight-text">${latest.text}</p>
                `;
            }

            // 2. UPDATE YOUR OLD REGULAR GALLERY (Still shows everything)
            if (gallery) {
                gallery.innerHTML = posts.map(p => {
                    let mediaHtml = "";
                    let badge = "Update";
                    
                    if(p.type === 'image') { badge = "Photos"; mediaHtml = `<img src="${p.media}" class="feed-media feed-img" alt="Post" onerror="this.src='https://i.postimg.cc/Y0jPr7Vy/20251205-103059-IMG-STYLE.jpg'">`; } 
                    else if(p.type === 'video') { badge = "Live Video"; mediaHtml = `<video controls class="feed-media feed-video"><source src="${p.media}" type="video/mp4"></video>`; } 
                    else if(p.type === 'audio') { badge = "DJ Mix Audio"; mediaHtml = `<audio controls class="feed-audio"><source src="${p.media}" type="audio/mpeg"></audio>`; }
